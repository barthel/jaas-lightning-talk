...
= [.xx-small]#Java# Authentication [.xx-small]#and Authorization Service#: Part 1 (Work in Progress)
{author}
...
* Zuverlässig und sicher feststellen, wer gerade Java-Code ausführt [.xx-small]#^<<footnote_1,1>>^#.

[.refs]
--
* [[footnote_1]][.xx-small]#^1.^# Übersetzung aus <<GUIDE>>
